  ...
  if (loading) {
    return (
      ...
      >
        ...
        <p style={{ marginTop: 16, fontSize: 16, color: '#666', fontWeight: '500'}}>Loading...</p>
      </div>
    );
  }
    ...
    <div className="App">
      ...
      <Router>
        <Routes>
          ...
          <Route
            path="/resume-builder"
            element={user ? <ResumeBuilderPage apiUser={user} /> : <Navigate to="/resume-builder/login" replace />}
          />
        </Routes>
      </Router>
    </div>
