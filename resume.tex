...
%%%%%% DEFINE ELEMENTS HERE %%%%%%%
    ...
    \newcommand{\name}{Somiran} % Your Name
    \newcommand{\course}{Chemical} % Your Course
    \newcommand{\roll}{123241} % Your Roll No.
    \newcommand{\phone}{6002163336} % Your Phone Number
    \newcommand{\emaila}{d.somiran@iitg.ac.in} % Email Personal
    %emailb
    \newcommand{\github}{SomiranDutta4}
    %website
    \newcommand{\linkedin}{SomiranDutta} % Your LinkedIn Profile
...
\begin{tabularx}{\linewidth}{L r}
  ...
  {Minor in } &  \href{https://github.com/\github}{Github}\\
...
{\dimexpr\textwidth-3mm\relax}{|c|C|c|c|}
  ...
  \textbf{Year}\\
  \hline
  Btech  & Indian Institute of Technology, Guwahati & 8.1 & 2024 \\ \hline 
\end{tabularx}}
\vspace{-2mm}
